...
public class RoomManager {
	...
	private static final Map<String, PokerRoom> userMap=new HashMap<>();//保存房主id对应的房间
	...
	public static void removeMap(User user,String roomName) {
		userMap.remove(user.getUserId());//将该房主移除
		roomMap.remove(roomName);//将房间移除
	}
}
